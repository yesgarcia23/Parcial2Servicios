...
namespace Parcial2.Clases
{
    public class clsCargaFotos
    {
            ...
            try
            {
                ...
                if (provider.FileData.Count > 0)
                {
                    ...
                    foreach (MultipartFileData file in provider.FileData)
                    {
                        ...
                        {
                            return request.CreateErrorResponse(HttpStatusCode.BadRequest, "El archivo no es una imagen válida.");
                        }
        ...
        private string ProcesarBD()
        {
            ...
            {
                case "FOTOPRENDA":
                    clsFotoPrenda foto = new clsFotoPrenda();
                    return foto.GrabarImagenPrenda(Convert.ToInt32(Datos), Archivos);
                default:
